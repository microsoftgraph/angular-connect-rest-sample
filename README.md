# Office 365 Angular Connect sample using Microsoft Graph API

Connecting to Office 365 is the first step every app must take to start working with Office 365 services and data. This sample shows how to connect and then call the Microsoft Graph API (formally known as "unified API (preview)"), and uses the Office Fabric UI to create an Office 365 experience.
